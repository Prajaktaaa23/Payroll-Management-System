...
from .forms import EmployeeRegistrationForm, HrRegistrationForm, LoginForm, UserUpdateForm, PasswordResetRequestForm, LeaveRequestForm
            ...
            if associated_users.exists():
                for user in associated_users:
                    ...
                    c = {
                        ...
                        "site_name": "Payroll Management System",
                        "uid": uid,
                        "user": user,
                        "token": token,
                        "protocol": "http",
